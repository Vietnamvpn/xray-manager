...
show_menu() {
    ...
    echo -e "${BLUE}======================================================================${NC}"
    echo -e "${YELLOW}1.${NC} Quản Lý Người Dùng   |   ${YELLOW}6.${NC} Xóa Tất Cả Mã Nguồn"
    echo -e "${YELLOW}2.${NC} Quản Lý Node Sever   |   ${YELLOW}7.${NC} Điều Khiển Xray"
    echo -e "${YELLOW}3.${NC} Quản Lý SSL          |   ${YELLOW}8.${NC} Bật/Tắt BBR"
    echo -e "${YELLOW}4.${NC} Đồng Bộ API          |   ${YELLOW}9.${NC} Tạo Bộ Nhớ Ảo Swap"
    echo -e "${YELLOW}5.${NC} Cập Nhật Mã Nguồn    |   ${YELLOW}10.${NC} Xem Trạng Thái VPS"
    echo -e "${YELLOW}0.${NC} Thoát                |   ${YELLOW}11.${NC} Xem Log Xray Trực Tiếp"
    echo -e "${BLUE}======================================================================${NC}"
    echo -e ""
